# Autonomous UAV Edge-Perception System

This repository contains the real-time, on-edge perception and geolocation software stack for an autonomous UAV. Engineered to run headlessly on an NVIDIA Jetson Nano during live flight, this system fuses computer vision with asynchronous MAVLink telemetry to detect ground targets and calculate their precise real-world GPS coordinates.

## System Output: Live Tracking & Geolocation

### Live Target Tracking
*(System successfully tracking targets, mitigating motion blur, and maintaining temporal ID via SORT Kalman Filtering)*

![Live Tracking 1](assets/live_tracking_1.gif)
![Live Tracking 2](assets/live_tracking_2.gif)

### Real-Time Geolocation
*(Live Edge-Computation Output: The center pixel of the bounding box is mathematically projected into 3D space utilizing UAV attitude data to calculate the exact WGS84 coordinates)*

![Detection Frame 1](assets/detection_frame_1.jpg)
![Detection Frame 2](assets/detection_frame_2.jpg)
